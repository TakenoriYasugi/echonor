...
import { createTopicPost } from "../graphql/mutations";
export default function TopicPostCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createTopicPost.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "TopicPostCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
